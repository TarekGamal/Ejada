...
public class ClassGenerator {
    ...
    public static File generateTableOutput(List<Column> columns, String tableName, String javaTableName) throws IOException {

        
        File outputFile = new File(javaTableName+".java");
    ...
    public static File generateViewOutput(List<Column> columns, String viewName, String javaTableName, String javaViewName,
            boolean createStringforDateFieldsCheckBox, boolean createBooleanforFlagFieldsCheckBox) throws IOException {

        File outputFile = new File(javaViewName+".java");
        outputFile.createNewFile();
        BufferedWriter out = new BufferedWriter(new FileWriter(outputFile));
        ...
        out.append("public class "+javaViewName+" implements Serializable {\n");
