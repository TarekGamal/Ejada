...
public class Service {
    ...
    public static File[] generate(String tableName, String viewName, String javaTableName, String javaViewName,
        ...
        if (javaTableName != null) {
            tableFile = ClassGenerator.generateTableOutput(tableColumns, tableName, javaTableName);
        }

        viewFile = null;
        if (javaViewName != null) {
            if (isViewRelatedToTable) {
                viewFile = ClassGenerator.generateViewOutput(viewColumns, viewName, isViewRelatedToTable ? javaTableName : null, javaViewName, createStringforDateFieldsCheckBox, createBooleanforFlagFieldsCheckBox);
            } else {
                viewFile = ClassGenerator.generateViewOutput(viewColumns, viewName, null, javaViewName, false, false);
            }
        }
