...
public class Generate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        chooseSaveDirectory = new javax.swing.JButton();
        ...
        createBooleanforFlagFieldsCheckBox.setText("create transient Boolean field for every");
        createBooleanforFlagFieldsCheckBox.setEnabled(false);

        chooseSaveDirectory.setLabel("choose save directory");
        chooseSaveDirectory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chooseSaveDirectoryActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(tableComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(31, 31, 31)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(viewComboBox, 0, 234, Short.MAX_VALUE)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(chooseSaveDirectory)))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(createStringforDateFieldsCheckBox)
                            .addComponent(createBooleanforFlagFieldsCheckBox))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(createBooleanforFlagFieldsCheckBox, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(generateButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(29, 29, 29))
        );

        chooseSaveDirectory.getAccessibleContext().setAccessibleName("");
    ...
    private void generateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateButtonActionPerformed
        ...
        if (tableComboBox.getSelectedIndex() == -1 && viewComboBox.getSelectedIndex() == -1) {
            ...
            try {
                File[] files = Service.generate(tableName, viewName, javaTableName, javaViewName,
    ...
    private void chooseSaveDirectoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooseSaveDirectoryActionPerformed
        ...
        fileChooser.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (fileChooser.showOpenDialog(Generate.this) == JFileChooser.APPROVE_OPTION) {
                    File parentDirectory = fileChooser.getCurrentDirectory();
                    Service.setParentDirectory(parentDirectory);
                    try {
                        saveDirectoryLabel.setText(parentDirectory.getCanonicalPath());
                    } catch (IOException ex) {
                        Logger.getLogger(Generate.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
        ...
        this.add(panel);
        pack();
    }//GEN-LAST:event_chooseSaveDirectoryActionPerformed
    ...
    private javax.swing.JButton chooseSaveDirectory;
